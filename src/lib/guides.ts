...
//
// `video` takes either a direct file URL (.mp4 / .webm / .mov, e.g. a file in
// /public/guides/) or an embed URL (YouTube, Loom, Vimeo "embed" links).
...
export const GUIDES: Guide[] = [
  ...
  {
    slug: "fix-a-failed-lesson",
    title: "Fix a failed lesson",
    summary: "What to do when a recording doesn't upload or finish processing.",
  },
  {
