...
// The platforms' own glyphs (from Simple Icons), drawn in currentColor so they
// pick up the footer's ink and hover like the text links do.
const SOCIAL_ICON: Record<Social["name"], string> = {
  Instagram:
          ...
          <div className="mb-2 flex gap-4">
            {SOCIAL_LINKS.map((s) => (
              <a
                ...
                target="_blank"
                rel="noopener"
                aria-label={`BumbleNote on ${s.name}`}
                className={LINK}
              >
